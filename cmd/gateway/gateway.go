...
import (
	...
	// NAS
	_ "github.com/minio/ming/cmd/gateway/nas"

	// Azure
	_ "github.com/minio/ming/cmd/gateway/azure"

	// S3
	_ "github.com/minio/ming/cmd/gateway/s3"

	// HDFS
	_ "github.com/minio/ming/cmd/gateway/hdfs"

	// GCS (use only if you must, GCS already supports S3 API)
	_ "github.com/minio/ming/cmd/gateway/gcs"
